mtasc -v -swf "%1\install\SWFUpload.swf" -version 8 -main -frame 1 -header 100:100:12 "%1\FlashDevelop\classes\*.as"
...
:jsmin
rem cmd /c "jsmin < "%1"FlashDevelop\swfupload.js > "%1"install\SWFUpload.js"
copy "%1"FlashDevelop\swfupload.js "%1"install\SWFUpload.js"
