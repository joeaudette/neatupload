...
SWFUpload.prototype.init = function(settings) {
	...
	// SWF Settings
	this.addSetting("upload_script", settings["upload_script"], "");													// The file that recieves the uploaded files from flash
...
SWFUpload.prototype.loadFlash = function() {
	...
	if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) {
		...
		sb.append('<embed type="application/x-shockwave-flash" src="' + this.getEncodedSetting("flash_path") + '" width="' + this.getSetting("flash_width") + '" height="' + this.getSetting("flash_height") + '"');
	...
	// Create IE Object HTML
		...
		sb.append('<param name="movie" value="' + this.getEncodedSetting("flash_path") + '" />');
...
SWFUpload.prototype._getFlashVars = function() {
	...
	var sb = new stringBuilder();
	sb.append("uploadScript=" + this.getEncodedSetting("upload_script"));
	sb.append("&allowedFiletypesDescription=" + this.getEncodedSetting("allowed_filetypes_description"))
	sb.append("&flashLoadedCallback=" + this.getEncodedSetting("flash_loaded_callback"));
	sb.append("&uploadFileQueuedCallback=" + this.getEncodedSetting("upload_file_queued_callback"));
	sb.append("&uploadFileStartCallback=" + this.getEncodedSetting("upload_file_start_callback"));
	sb.append("&uploadProgressCallback=" + this.getEncodedSetting("upload_progress_callback"));
	sb.append("&uploadFileCompleteCallback=" + this.getEncodedSetting("upload_file_complete_callback"));
	sb.append("&uploadQueueCompleteCallback=" + this.getEncodedSetting("upload_queue_complete_callback"));
	sb.append("&uploadDialogCancelCallback=" + this.getEncodedSetting("upload_dialog_cancel_callback"));
	sb.append("&uploadFileErrorCallback=" + this.getEncodedSetting("upload_file_error_callback"));
	sb.append("&uploadFileCancelCallback=" + this.getEncodedSetting("upload_file_cancel_callback"));
	sb.append("&uploadQueueCompleteCallback=" + this.getEncodedSetting("upload_queue_complete_callback"));
	sb.append("&autoUpload=" + this.getEncodedSetting("auto_upload"));
	sb.append("&allowedFiletypes=" + this.getEncodedSetting("allowed_filetypes"));
	sb.append("&maximumFilesize=" + this.getEncodedSetting("allowed_filesize"));
...
SWFUpload.prototype.getEncodedSetting = function(name) {
	var value = this.getSetting(name);
	if (value != null) {
